...
# Configuration
DB_PATH = Path("/home/ubuntu/.openclaw/workspace/rei-provider-system/data/providers.db")
PROGRESS_FILE = Path("/home/ubuntu/.openclaw/workspace/rei-provider-system/data/npi_registry_progress.json")
RESULTS_FILE = Path("/home/ubuntu/.openclaw/workspace/rei-provider-system/data/npi_registry_results.json")
LOG_FILE = Path("/home/ubuntu/.openclaw/workspace/rei-provider-system/data/npi_registry.log")
