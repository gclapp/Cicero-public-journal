#!/usr/bin/env python3
"""Run Healthgrades v2 scraper to extract providers with ratings, photos, phones."""
...
async def main():
    """Run the Healthgrades v2 scraper."""
    print("=" * 70)
    print("🏥  HEALTHGRADES V2 SCRAPER - Ratings, Photos, Phone Numbers")
    print("=" * 70)
    print()
    ...
    # Create search criteria for max_pages=78
    criteria = SearchCriteria(
        zip_code="90210",  # Not used for Healthgrades but required
        radius_miles=100,
        max_pages=78
    )
    ...
    print(f"   Extracting: ratings, review counts, photos, phones, profile URLs")
    print()
